...
```
{
  ...
  resource: "gid://shopify/Metaobject/123",
...
保管 90 日 (Shopify Metaobject quota 範囲内)。
...
| CTO (assigned to Claude) | Claude Sonnet 4 | 2026-05-15 | ✓ 起案 |

次回更新: Phase M-Audit 完了後 (脅威モデル運用検証反映)
